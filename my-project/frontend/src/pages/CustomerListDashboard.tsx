...
const customers: Customer[] = Array.from({ length: 50 }, (_, i) => {
    ...
    const companies = [
        "商事", "産業", "エンタープライズ", "メタル", "トレーディング", "電材",
        "物流", "サービス", "工業", "リサイクル", "工務店", "企画", "建設", "技研", "ファクトリー"
    ];
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "row", gap: 24, alignItems: "stretch", padding: 24, paddingTop: 0 }}>
                ...
                >
                    ...
                    <div style={{
                        ...
                        <span style={{ fontWeight: "bold", fontSize: 15, marginRight: 8 }}>■ バブル色凡例：</span>
                        {colorScale.map(item => (
                            <span key={item.label} style={{ marginRight: 20, display: "inline-flex", alignItems: "center" }}>
                                <span style={{
