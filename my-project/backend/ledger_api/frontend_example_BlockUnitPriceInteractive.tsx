// frontend/components/BlockUnitPriceInteractive.tsx
...
const BlockUnitPriceInteractive: React.FC = () => {
    ...
    const startProcess = async () => {
        ...
        try {
            const response = await axios.post('/api/block-unit-price/start', {
                files: files
            });
    ...
    const selectTransportVendors = async () => {
        ...
        try {
            const response = await axios.post('/api/block-unit-price/select-transport', {
    ...
    const finalizeCalculation = async (confirmed: boolean = true) => {
        ...
        try {
            const response = await axios.post('/api/block-unit-price/finalize', {
                session_data: state.sessionData,
                confirmed: confirmed
            });
