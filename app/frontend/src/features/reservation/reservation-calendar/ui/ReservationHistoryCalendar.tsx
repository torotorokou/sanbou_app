                ...
                {week.map((date, dayIdx) => {
                  ...
                  return (
                    <div
                      ...
                      title={
                        data
                          ? `クリックで詳細確認 - 台数: ${data.reserve_trucks}, 企業数: ${data.total_customer_count ?? 0}, 固定客: ${data.fixed_customer_count ?? 0}`
                          : undefined
                      }
                    >
                      <div
                    ...
                    {data && (
                      <>
                        ...
                        <p style={{ margin: "4px 0" }}>
                          ...
                          {data.total_customer_count ?? 0}社
                        </p>
                        <p style={{ margin: "4px 0" }}>
                          <strong>固定客企業数:</strong>{" "}
                          {data.fixed_customer_count ?? 0}社
                        </p>
