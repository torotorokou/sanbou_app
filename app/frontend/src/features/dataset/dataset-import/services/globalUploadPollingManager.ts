...
class GlobalUploadPollingManager {
  ...
  addJobs(uploadFileIds: Record<string, number>): void {
    logger.log("[GlobalPollingManager] Adding jobs:", uploadFileIds);
  ...
  private start(): void {
    ...
    this.isRunning = true;
    logger.log("[GlobalPollingManager] Starting polling...");
  ...
  private async checkAll(): Promise<void> {
    ...
    logger.log(`[GlobalPollingManager] Checking ${jobArray.length} jobs...`);
  ...
  private stop(): void {
    ...
    logger.log("[GlobalPollingManager] Stopped polling.");
  }
  ...
  clearAll(): void {
    this.jobs.clear();
    this.stop();
    logger.log("[GlobalPollingManager] All jobs cleared.");
  }
