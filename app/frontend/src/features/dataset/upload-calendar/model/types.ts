...
export const CSV_UPLOAD_KIND_MASTER: CsvUploadKindMaster[] = [
  ...
  { kind: 'shogun_flash_receive',  label: '将軍速報版 受入',  color: '#16a34a', category: '将軍速報版' },
  { kind: 'shogun_flash_shipment', label: '将軍速報版 出荷',  color: '#ff5d5dff', category: '将軍速報版' }, 
  { kind: 'shogun_flash_yard',     label: '将軍速報版 ヤード', color: '#ffe600ff', category: '将軍速報版' }, 

  // 将軍最終版
  { kind: 'shogun_final_receive',  label: '将軍最終版 受入',  color: '#a940ffff', category: '将軍最終版' }, 
  { kind: 'shogun_final_shipment', label: '将軍最終版 出荷',  color: '#db2777', category: '将軍最終版' }, 
  { kind: 'shogun_final_yard',     label: '将軍最終版 ヤード', color: '#4338ca', category: '将軍最終版' }, 

  // マニフェスト
  { kind: 'manifest_stage1',       label: 'マニフェスト 1次', color: '#08d464ff', category: 'マニフェスト' },
  { kind: 'manifest_stage2',       label: 'マニフェスト 2次', color: '#f97316', category: 'マニフェスト' },
];
