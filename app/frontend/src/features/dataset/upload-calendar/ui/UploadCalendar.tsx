...
import {
  getKindsByDatasetKey,
  getMasterByDatasetKey,
  type CsvUploadKind,
} from "../model/types";
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <Text
            strong
            style={{ fontSize: 18, minWidth: 160, textAlign: "center" }}
          >
            ...
            {WEEKDAYS.map((day, idx) => (
              <div
                ...
                style={{
                  ...
                  fontWeight: "bold",
                  color:
                    idx === 5 ? "#1890ff" : idx === 6 ? "#ff4d4f" : "#595959",
                  padding: "8px 0",
                }}
              >
                {day}
            ...
            >
              {week.days.map((day, dayIdx) => {
                ...
                const filteredUploads = Object.entries(day.uploadsByKind)
                  .filter(([kind]) =>
                    allowedKinds.includes(kind as CsvUploadKind),
                  )
                  .flatMap(([, items]) => items || []);
