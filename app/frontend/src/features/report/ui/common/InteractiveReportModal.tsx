...
import { modalStepsMap, isInteractiveReport } from '@features/report';
import BlockUnitPriceInteractive from '@/components/Report/interactive/BlockUnitPriceInteractive';
