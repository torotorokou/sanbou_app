...
import type { SampleSectionProps } from '@features/report/types/report.types';
import ReportSampleThumbnail from '@features/report/report-viewer/ui/ReportSampleThumbnail';
