...
import { fetchTargetMetrics, type TargetMetricsDTO, type FetchMode } from "../infrastructure/targetMetrics.api";
 ...
 */
export function useTargetMetrics(date: string, mode: FetchMode = "monthly"): UseTargetMetricsResult {
