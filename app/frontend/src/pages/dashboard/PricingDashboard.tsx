    ...
    <div style={{ padding: 24 }}>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} md={12} xl={8}>
          <Card title="全体平均単価" extra={<DollarCircleOutlined />} hoverable>
            <Text>直近月：¥10.5 / kg</Text>
            <br />
            <Text type="secondary">利益率変化や値下がり傾向の確認</Text>
          </Card>
        </Col>

        {/* ✅ 商品別単価 */}
        <Col xs={24} md={12} xl={8}>
          <Card title="商品別単価" extra={<ShoppingCartOutlined />} hoverable>
            <Text>高単価商品を重点分析・販売強化</Text>
            <br />
            <Text type="secondary">例：A商品 ¥12/kg、B商品 ¥8/kg</Text>
          </Card>
        </Col>

        {/* ✅ 営業者別単価 */}
        <Col xs={24} md={12} xl={8}>
          <Card title="営業者別単価" extra={<TeamOutlined />} hoverable>
            <Text>営業ごとの値引傾向・交渉力の評価</Text>
            <br />
            <Text type="secondary">例：営業A ¥11/kg、営業B ¥9/kg</Text>
          </Card>
        </Col>
