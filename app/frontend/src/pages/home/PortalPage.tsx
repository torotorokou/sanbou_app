...
export const PortalPage: React.FC = () => {
  ...
  return (
    <div className={styles.portalPage} style={{ minHeight: "100%" }}>
      <section className={styles.portalHero} style={heroVars}>
        <Title level={2} className={styles.portalTitle}>
          参謀くん-社内ポータル
        </Title>
        {!isXs && <Text className={styles.portalSubtitle}>{introText}</Text>}
      </section>
