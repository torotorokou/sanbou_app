...
import { useAnnouncementBannerViewModel, AnnouncementBanner } from '@features/announcements';
import { PortalCard, portalMenus, CARD_WIDTH, CARD_HEIGHT, BUTTON_WIDTH } from '@features/portal';
