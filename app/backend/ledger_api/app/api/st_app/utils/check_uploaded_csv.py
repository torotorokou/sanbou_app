from app.api.st_app.app_pages.manage.view import render_upload_header
import tempfile
...
def render_csv_upload_section(upload_key: str):
    ...
    Args:
        upload_key (str): ファイル種別キー（例: "shipment", "yard", "receive"）
    """
...
def check_single_file_uploaded(
    ...
    Args:
        ...
        required_key (str): 対象のファイルキー名（例: 'shipment'）
