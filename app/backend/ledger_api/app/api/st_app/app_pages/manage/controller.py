...
from app.api.st_app.components.custom_button import centered_button, centered_download_button
from app.api.st_app.components.custom_progress_bar import CustomProgressBar
from app.api.st_app.components.ui_message import show_warning_bubble

# ✅ プロジェクト内 - view（UIビュー）
from app.api.st_app.app_pages.manage.view import render_manage_page

# ✅ プロジェクト内 - logic（処理・データ変換など）
from app.api.st_app.logic.manage import template_processors
from app.api.st_app.logic.controllers.csv_controller import prepare_csv_data
from app.api.st_app.logic.manage.utils.upload_handler import handle_uploaded_files
from app.api.st_app.logic.manage.utils.file_validator import check_missing_files
from app.api.st_app.logic.detect_csv import detect_csv_type
...
from app.api.st_app.utils.debug_tools import save_debug_parquets
...
def render_file_upload_section(
    ...
    """
    from app.api.st_app.app_pages.manage.view import (
