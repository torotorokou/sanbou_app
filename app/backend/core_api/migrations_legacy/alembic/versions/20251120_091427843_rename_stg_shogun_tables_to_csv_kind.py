...
def upgrade() -> None:
    ...
    index_renames = [
        ...
        ('idx_receive_shogun_flash_upload_file_id', 'idx_shogun_flash_receive_upload_file_id'),
        ...
        ('idx_shipment_shogun_flash_upload_file_id', 'idx_shogun_flash_shipment_upload_file_id'),
        ('idx_shipment_shogun_flash_is_deleted', 'idx_shogun_flash_shipment_is_deleted'),
        # yard flash
        ('idx_yard_shogun_flash_slip_date', 'idx_shogun_flash_yard_slip_date'),
        ('idx_yard_shogun_flash_upload_file_id', 'idx_shogun_flash_yard_upload_file_id'),
        ...
        ('idx_receive_shogun_final_upload_file_id', 'idx_shogun_final_receive_upload_file_id'),
        ...
        ('idx_shipment_shogun_final_upload_file_id', 'idx_shogun_final_shipment_upload_file_id'),
        ('idx_shipment_shogun_final_is_deleted', 'idx_shogun_final_shipment_is_deleted'),
        # yard final
        ('idx_yard_shogun_final_slip_date', 'idx_shogun_final_yard_slip_date'),
        ('idx_yard_shogun_final_upload_file_id', 'idx_shogun_final_yard_upload_file_id'),
    ...
    constraint_table_map = [
        ...
        # receive flash
        ('receive_shogun_flash_pkey', 'shogun_flash_receive_pkey', 'shogun_flash_receive'),
        ('receive_shogun_flash_upload_file_id_fkey', 'shogun_flash_receive_upload_file_id_fkey', 'shogun_flash_receive'),
        # shipment flash
        ('shipment_shogun_flash_pkey', 'shogun_flash_shipment_pkey', 'shogun_flash_shipment'),
        ('shipment_shogun_flash_upload_file_id_fkey', 'shogun_flash_shipment_upload_file_id_fkey', 'shogun_flash_shipment'),
        # yard flash
        ('yard_shogun_flash_pkey', 'shogun_flash_yard_pkey', 'shogun_flash_yard'),
        ('yard_shogun_flash_upload_file_id_fkey', 'shogun_flash_yard_upload_file_id_fkey', 'shogun_flash_yard'),
        # receive final
        ('receive_shogun_final_pkey', 'shogun_final_receive_pkey', 'shogun_final_receive'),
        ('receive_shogun_final_upload_file_id_fkey', 'shogun_final_receive_upload_file_id_fkey', 'shogun_final_receive'),
        # shipment final
        ('shipment_shogun_final_pkey', 'shogun_final_shipment_pkey', 'shogun_final_shipment'),
        ('shipment_shogun_final_upload_file_id_fkey', 'shogun_final_shipment_upload_file_id_fkey', 'shogun_final_shipment'),
        # yard final
        ('yard_shogun_final_pkey', 'shogun_final_yard_pkey', 'shogun_final_yard'),
        ('yard_shogun_final_upload_file_id_fkey', 'shogun_final_yard_upload_file_id_fkey', 'shogun_final_yard'),
    ]
...
def downgrade() -> None:
    ...
    index_renames = [
        ...
        ('idx_shogun_flash_receive_upload_file_id', 'idx_receive_shogun_flash_upload_file_id'),
        ...
        ('idx_shogun_flash_shipment_upload_file_id', 'idx_shipment_shogun_flash_upload_file_id'),
        ('idx_shogun_flash_shipment_is_deleted', 'idx_shipment_shogun_flash_is_deleted'),
        ('idx_shogun_flash_yard_slip_date', 'idx_yard_shogun_flash_slip_date'),
        ('idx_shogun_flash_yard_upload_file_id', 'idx_yard_shogun_flash_upload_file_id'),
        ...
        ('idx_shogun_final_receive_upload_file_id', 'idx_receive_shogun_final_upload_file_id'),
        ...
        ('idx_shogun_final_shipment_upload_file_id', 'idx_shipment_shogun_final_upload_file_id'),
        ('idx_shogun_final_shipment_is_deleted', 'idx_shipment_shogun_final_is_deleted'),
        ('idx_shogun_final_yard_slip_date', 'idx_yard_shogun_final_slip_date'),
        ('idx_shogun_final_yard_upload_file_id', 'idx_yard_shogun_final_upload_file_id'),
