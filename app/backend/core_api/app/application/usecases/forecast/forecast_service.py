...
DEPRECATED: このServiceは非推奨です。
  - 代わりに app/application/usecases/forecast/forecast_job_uc.py の各UseCase を使用してください
    * CreateForecastJobUseCase: ジョブ作成
    * GetForecastJobStatusUseCase: ジョブステータス取得
    * GetPredictionsUseCase: 予測結果取得
