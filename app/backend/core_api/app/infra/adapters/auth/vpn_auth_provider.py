...
class VpnAuthProvider(IAuthProvider):
    ...
    def __init__(self) -> None:
        ...
        VPN_USER_EMAIL が未設定の場合はデフォルト値を使用します。
        """
        self._vpn_user_email = os.getenv("VPN_USER_EMAIL", "vpn-user@honest-recycle.co.jp")
        ...
        logger.info(
            ...
            extra=create_log_context(
                ...
                metadata={"display_name": self._vpn_user_display_name},
            ),
        )
