...
def upgrade() -> None:
    ...
    op.create_index('ix_jobs_forecast_jobs_status', 'forecast_jobs', ['status'], unique=False, schema='jobs')
    ...
    op.create_index('ix_core_inbound_actuals_date', 'inbound_actuals', ['date'], unique=False, schema='core')
