...
class TestMaterializedViewRefresher:
    ...
    def test_extract_csv_type_from_csv_kind(self):
        """静的メソッドのテスト"""
        assert MaterializedViewRefresher.extract_csv_type_from_csv_kind("shogun_flash_receive") == "receive"
        assert MaterializedViewRefresher.extract_csv_type_from_csv_kind("shogun_final_shipment") == "shipment"
        assert MaterializedViewRefresher.extract_csv_type_from_csv_kind("shogun_flash_yard") == "yard"
